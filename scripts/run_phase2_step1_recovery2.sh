#!/bin/bash
# Phase 2 Step 1 recovery v2 — pickup after SIGTERM killed R3-v2.
# R2-v2 already complete (final.pt exists). Now: R3-v2 fresh + R4-v2 + 3 evals.
set -o pipefail
cd /workspace/DisMo
PORT=29570
...
step "TRAIN R3-v2 (simsiam, eff lr 0.05, 80ep) -- RESTART"
...
[ $rA -ne 0 ] || [ $rB -ne 0 ] && { echo "ABORT_PIPELINE eval R2/R3 v2 rA=$rA rB=$rB"; exit 1; }
